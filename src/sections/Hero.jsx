            ...
            <div className=" space-y-8">
                <div className=" ml-0 md:ml-12 animate-fade-in animate-delay-100">
                    <span className=" inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-(--color-primary) ">
                        <span className=" w-2 h-2 bg-(--color-primary) rounded-full animate-pulse " /> Software Developer <span className=" text-(--color-muted-foreground) rotate-30">Student</span> 
                    </span>
                </div>
                {/*HEADLINE*/}
